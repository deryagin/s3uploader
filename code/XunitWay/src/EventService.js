...
module.exports = S3Uploader_XunitWay_EventService;

function S3Uploader_XunitWay_EventService() {
   ...
   * @returns {S3Uploader_XunitWay_EventService}
   */
  ...
  /**
   * @emits {S3Uploader_XunitWay_EventType.SERVICE_START}
   */
  ...
  /**
   * @emits {S3Uploader_XunitWay_EventType.SERVICE_STOP}
   */
   ...
   * @emits {S3Uploader_XunitWay_EventType.EMERGED_FILE}
   */
   ...
   * @param {String} localPath
   * @param {fs.Stats} fsStats
   * @emits {S3Uploader_XunitWay_EventType.MOVE_NEEDED}
   */
   ...
   * @param {String} from
   * @param {String} to
   * @emits {S3Uploader_XunitWay_EventType.MOVE_SUCCEED}
   */
   ...
   * @param {String} from
   * @param {String} to
   * @emits {S3Uploader_XunitWay_EventType.MOVE_FAILING}
   */
